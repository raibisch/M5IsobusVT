...
class TFT_eSprite : public TFT_eSPI {
 public:
  ...
  void getRotatedBounds(float sina, float cosa, int16_t w, int16_t h,
                        int16_t xp, int16_t yp, int16_t *min_x, int16_t *min_y,
  ...
  void pushImage(int32_t x0, int32_t y0, int32_t w, int32_t h, uint16_t *data,uint16_t transp);
  void pushImage(int32_t x0, int32_t y0, int32_t w, int32_t h,const uint16_t *data);
  void pushImageAlpha(int32_t x, int32_t y, int32_t w, int32_t h, uint16_t *data, uint8_t *dataAlpha,uint16_t transp);

  void pushInSprite(TFT_eSprite *spr, int32_t srcX, int32_t srcY, int32_t srcW,
                    int32_t srcH, int32_t desX, int32_t desY);
